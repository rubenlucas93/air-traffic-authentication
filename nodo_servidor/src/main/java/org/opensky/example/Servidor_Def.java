...
double errorrecepcion= 500 ; //500 nanosegundos//
double errorGPS = 1000; //1 microsegundo//
...
public void insertarLapso(informacion nodo){
      ...
      if (mapa.containsKey(nodo.IDAvion)) {
            ...
            //ESTO ES PARA COMPROBAR QUE PUEDO DEJAR DE OCUPAR UN BUFFER PORQUE EL MENSAJE comun 4 DE UNA DE LAS PLACAS SE HA PERDIDO//
